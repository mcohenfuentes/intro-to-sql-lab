...
SELECT countries.name, countries.population FROM countries WHERE region = 'Southern Europe';
...
SELECT countrycode FROM countrylanguages WHERE language = 'Italian' AND countrylanguages.isofficial = TRUE AND countrylanguages.percentage = 100;
